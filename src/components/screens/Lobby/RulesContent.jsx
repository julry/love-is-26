            ...
            <GlassBlock $angle={135} brightness={1.1} saturation={1.2}>
                <RulesBlock>
                    ...
                    <Text>
                        ...
                        так компании взращивают любовь своих сотрудников. Собери все сердца, чтобы узнать, что значит любовь для каждого работодателя и принять участие в большом розыгрыше призов.
                    </Text>
                    <ButtonStyled
                        glassProps={{
                            $percentage: 5,
