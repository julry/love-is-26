                            ...
                            <Wrapper exit={{ opacity: 0 }}>
                                ...
                                >
                                    <svg width="100%" height="100%" viewBox="0 0 37 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.7077 14.9271V4.77716C10.7077 1.93061 13.8712 0.224538 16.2497 1.78839L33.2309 12.9534C35.4735 14.4279 35.3536 17.7552 33.0108 19.0646L11.9569 30.831C11.155 31.2792 10.2052 31.4181 9.34024 31.1087C3.59764 29.0547 -1.11444 23.7399 2.40158 21.0626C4.06055 19.7994 5.9119 20.0648 7.63803 21.604C8.36028 19.258 9.80483 18.5362 11.4299 18.5362C15.2643 18.5362 16.0962 24.3753 11.4299 27.3561" stroke="#FFF6EF" strokeWidth="2.38462" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </StartButton>
