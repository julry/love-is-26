                ...
                <Card $isLandscape={isLandscape}>
                    {isLandscape ? (
                        <>
                            ...
                            <PrizeGroup>
                                <Amount $ratio={ratio}>5x</Amount>
                                <Element $top={10} $left={200} $width={200} $height={179} src={otpPrize} alt=""/>
                            </PrizeGroup>
                        </>
                    ) : (
                        <>
                            ...
                            <PrizeGroup>
                                <Amount $ratio={ratio}>5x</Amount>
                                <Element $top={4} $left={152 * ratio} $width={159 * ratio} $height={143 * ratio} src={otpPrize} alt=""/>
                            </PrizeGroup>
                            <Element $top={-43 * ratio} $left={94 * ratio} $width={141 * ratio} $height={84 * ratio} src={topLamps} alt=""/>
                            <Element $shouldRotate $top={38 * ratio} $left={-35 * ratio} $width={70 * ratio} $height={87 * ratio} src={rightLamps} alt=""/>
                        </>
                ...
                {!isLandscape && (
                    <ButtonWrapper>
                        <Button onClick={() => contentRef.current?.scrollTo({top: 0, behavior: 'smooth'})} isIcon svgProps={{ svgWidth: 10, svgHeight: 17 }}>
                            ...
                            <path d="M5 1V16" stroke="#FFF6EF" strokeWidth="2" strokeLinecap="round"/>
                            <path d="M1 5.5L5 1L9 5.5" stroke="#FFF6EF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </Button>
                    </ButtonWrapper>
                )}
